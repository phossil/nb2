...
(defvar quote-list '("http://housequote.com/menagerie/photos/birds/cowboygosling.jpg"
...
;; quote is already a reserved keyword, so a different function name is used
(defun lain-quote ()
  (format nil (nth (random (length quote-list)) quote-list)))
